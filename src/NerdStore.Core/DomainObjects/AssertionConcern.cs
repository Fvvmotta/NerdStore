...
namespace NerdStore.Core.DomainObjects
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentLessOrEqualsMinimum(double value, double minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessOrEqualsMinimum(float value, float minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessOrEqualsMinimum(int value, int minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessOrEqualsMinimum(long value, long minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessOrEqualsMinimum(decimal value, decimal minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
